...
export const settings = {
  site_name: 'Σύλλογος Φίλων Στήριξης Κέντρου Υγείας Τροπαίων',
  ...
  address: 'Κέντρο Υγείας Τροπαίων, Τρόπαια',
  ...
  president_name: 'Διοίκηση Συλλόγου',
  president_title: 'Μέλη Διοίκησης',
  president_image_url: '',
  president_message: 'Η διοίκηση του συλλόγου εργάζεται για να δημιουργεί ένα ασφαλές, ανοιχτό και ενεργό περιβάλλον για όλα τα μέλη και την κοινότητα μας. Στόχος μας είναι η στήριξη, η ενημέρωση και η προώθηση της δημόσιας υγείας σε κάθε επίπεδο.',
  donation_iban: '',
