  ...
  return (
    <div
      ...
      style={{
        ...
        // Critical for mobile: prevent scrolling inside this element during drag
        touchAction: 'none',
...
export default function Gallery() {
  ...
  // ─── Sensors: split Mouse & Touch for reliable mobile dragging ───
  const sensors = useSensors(
    // Desktop: dragging starts as soon as you move 5px
    useSensor(MouseSensor, {
      activationConstraint: { distance: 5 },
    }),
    // Mobile: hold for 180ms then drag (iOS-like)
        ...
        <>
          ...
          >
            <SortableContext items={orderedItems.map((i) => i.id)} strategy={rectSortingStrategy}>
              <div
                className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 select-none"
